  ...
  return (
    ...
    <div className="mx-10 flex flex-col md:flex-row justify-between">
      ...
      <div className="flex-1 flex flex-col xl:flex-row">
        ...
        <div className="text-center text-2xl text-gray-500 mx-4">
      ...
      <div className="border-l-2 border-gray-500 h-96 mx-4 hidden xl:block"></div>
      <div className="border-t-2 mt-6 border-gray-500 h-2 xl:hidden"></div>
      {/* I++ Section */}
      <div className="flex-1 flex flex-col xl:flex-row">
